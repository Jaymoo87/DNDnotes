...
const Error = () => {
  return (
    <div className="h-full flex flex-col items-center justify-center sapce-y-4">
      <Image src={"/errorImage.png"} height={"300"} width={"300"} alt="Error" className="dark:hidden" />
      <Image src={"/errorImage.png"} height={"300"} width={"300"} alt="Error" className="hidden dark:block" />
