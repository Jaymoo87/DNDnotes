        ...
        {initialData.isPublished ? (
          <div className="space-y-4">
            <div className="flex items-center gap-x-2">
              ...
              <p className="text-xs font-medium text-sky-500">This Memory Can Be Seen By All</p>
            </div>
            <div className="flex items-center">
              <input value={url} className="flex-1 px-2 text-xs border rouded-l-md h-8 bg-muted truncate" disabled />
          ...
          <div className="flex flex-col items-center justify-center">
            ...
            <span className="text-xs text-muted-foreground mb-4">Share Your Memories With Someone</span>
